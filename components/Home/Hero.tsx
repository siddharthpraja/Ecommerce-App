...
const Hero = () => {
  return (
    <div className="w-full my-5 bg-blue-50 rounded-3xl h-[60vh] relative">
      <div className="lg:p-20 md:px-10 p-8 items-start space-y-3 absolute z-20 ">
        <h1 className="text-5xl font-bold text-neutral-800">
          Lighnting Fast Shipping
        </h1>
        <h1 className="text-xl  text-neutral-800">Lighnting Fast Shipping</h1>
      </div>
      <Image
        src={bg}
        alt="bg"
        width={500}
        height={500}
        className="bg-cover md:w-1/2 w-3/4 h-3/4 absolute right-0 bottom-0 z-10"
      />
